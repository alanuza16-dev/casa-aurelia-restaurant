...
function openInstagram() { const appLink = "instagram://user?username=casaaurelia"; const webLink = "https://www.instagram.com/casaaurelia/"; window.location.href = appLink; setTimeout(function () { window.open(webLink, "_blank"); }, 1500); }
function openFacebook() { const appLink = "fb://profile/casaaurelia"; const webLink = "https://www.facebook.com/casaaurelia"; window.location.href = appLink; setTimeout(function () { window.open(webLink, "_blank"); }, 1500); }
