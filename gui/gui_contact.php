...
<section class="contact-section contact-variant-glass-premium-dark" id="contact">
    <div class="container px-4 px-lg-5">
        <div class="text-center mb-5">
            ...
            <h2 class="contact-title">Haz tu reserva</h2>
            <p class="contact-subtitle">Una propuesta pensada para clientes que valoran servicio, detalle y una experiencia superior.</p>
        </div>
        <div class="row gx-4 gx-lg-5">
            <div class="col-md-4 mb-3 mb-md-0"><div class="card py-4 h-100"><div class="card-body text-center"><i class="fas fa-map-marked-alt text-primary mb-2"></i><h4 class="text-uppercase m-0">Ubicacion</h4><hr class="my-4 mx-auto" /><div class="small text-black-50"><?php echo $site['address'] ?? ''; ?></div></div></div></div>
